...
```{r, eval=FALSE}
fl <- readRDS('../fungen-xqtl-analysis/analysis/TCW_BU/ROSMAP/mqtl/outputs/01-ROSMAP_methylation_data_preprocessing/flashier_opti_factors.rds')
...
```{r, eval=FALSE}
pheno <- read_delim('../fungen-xqtl-analysis/analysis/TCW_BU/ROSMAP/mqtl/outputs/01-ROSMAP_methylation_data_preprocessing/ROSMAP_assay_methylationArray_metadata.sesame.beta.bed.gz', 
                   delim = '\t')
